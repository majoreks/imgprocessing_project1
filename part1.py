...
truePlantsPath = "multi_label/part1"
...
for file in os.listdir(plantsPath):
    ...
    imToWrite = closing
    cv.imwrite("res/tmp3/"+"prediction_"+file.split("_", 1)[1], imToWrite)
    predictedPlants[plantId].append(imToWrite)
